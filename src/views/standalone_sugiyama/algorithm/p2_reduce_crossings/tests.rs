...
mod insert_dummy_vertices {
    ...
    use crate::{
        views::standalone_sugiyama::algorithm::p2_reduce_crossings::{
        ...
        views::standalone_sugiyama::configure::Config,
    };
    ...
    fn bundle_dummy_vertices_ping_graph() {
        ...
        crate::views::standalone_sugiyama::algorithm::start(g, &c);
    }
}

mod init_order {
    use crate::views::standalone_sugiyama::algorithm::insert_dummy_vertices;
...
mod order {
    use crate::views::standalone_sugiyama::algorithm::{
        p2_reduce_crossings::order_layer, p2_reduce_crossings::Order, Edge, Vertex,
    };
    use petgraph::stable_graph::StableDiGraph;
    ...
    fn test_barycenter() {
        ...
        let expected_order = order_layer(
            ...
            false,
            &order,
            crate::views::standalone_sugiyama::algorithm::p2_reduce_crossings::barycenter,
        );
        assert_eq!(
