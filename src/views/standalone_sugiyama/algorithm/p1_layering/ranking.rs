...
#[allow(dead_code)]
pub fn print_ranks(graph: &StableDiGraph<Vertex, Edge>) {
...
pub fn feasible_tree(graph: &mut StableDiGraph<Vertex, Edge>, minimum_length: i32) {
...
pub fn init_rank(graph: &mut StableDiGraph<Vertex, Edge>, minimum_length: i32) {
    ...
    info!(target: "ranking", "Initializing ranks");
...
pub fn update_ranks(graph: &mut StableDiGraph<Vertex, Edge>, minimum_length: i32) {
...
mod tests {
    ...
    use crate::views::standalone_sugiyama::algorithm::p1_layering::{
