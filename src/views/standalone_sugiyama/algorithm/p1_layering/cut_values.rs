...
pub fn init_cutvalues(graph: &mut StableDiGraph<Vertex, Edge>) {
...
mod tests {
    ...
    use crate::views::standalone_sugiyama::algorithm::{
        p1_layering::cut_values::{init_cutvalues, remove_outdated_cut_values, update_cutvalues},
        p1_layering::low_lim::init_low_lim,
        p1_layering::tests::{
