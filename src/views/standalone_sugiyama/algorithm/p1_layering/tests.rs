...
mod integration {
    ...
    use crate::views::standalone_sugiyama::configure::{Config, RankingType};
    use petgraph::stable_graph::StableDiGraph;

    use crate::views::standalone_sugiyama::algorithm::{rank, slack, Edge, Vertex};
    ...
    fn db_nmpi_hlrs() {
        ...
        crate::views::standalone_sugiyama::algorithm::start(graph, &cfg);
    }
}
